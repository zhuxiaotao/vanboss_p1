...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			<img src="/imgs/bobosilog.png"
				...
				class="navbar-brand">沃柏斯物联网控制系统 v0.1</a>
		</div>
		<!-- /.navbar-header -->
				...
				<ul class="nav" id="side-menu">
					<li class="sidebar-search">
						<div class="input-group custom-search-form">
							...
							欢迎:&nbsp&nbsp&nbsp${user.username}
							</h3>
						</div> <!-- /input-group -->
					</li>
					<li><a href="customer.action">
					...
					<li><a href="salevisit.action"><i
							class="glyphicon glyphicon-filter"></i> 智慧实验室</a></li>
					<li><a href="salevisit.action"><i
							class="glyphicon glyphicon-cloud-download"></i> 云计服务</a></li>
					<li><a href="salevisit.action"><i
	...
	$(function(){
		...
		function threadstop(){
			$.ajax({
				url : "http://192.168.27.1:8080/threadstop.do",
				type : "post",
				contentType : "application/json;charset=UTF-8",
				dataType : "text",
				success : function(data){
