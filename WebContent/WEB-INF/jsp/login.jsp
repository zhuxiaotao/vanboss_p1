	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4">
				...
				<!-- Start Sign In Form -->
				<form action="/login.do" class="fh5co-form animate-box"
					data-animate-effect="fadeInLeft">
					<h2>登 录</h2>
					<div class="form-group">
						<label for="username" class="sr-only">用户名</label> <input
							type="text" class="form-control" name="username" id="用户名"
					...
					<div class="form-group">
						<p>
							忘记密码?&nbsp&nbsp&nbsp&nbsp <a href="/userRegisterShow.do">注册</a> |
							<a href="forgot2.html">忘记密码?</a>
						</p>
					</div>
					<div class="form-group">
